...
namespace Rivet {
  ...
  class CMS_2020_I1758692 : public Analysis {
  public:

    /// Constructor
    DEFAULT_RIVET_ANALYSIS_CTOR(CMS_2020_I1758692);
    ...
    void init() {
      ...
      // Particles: K0S, Lambda, Anti-Lambda, Xi-, Anti-Xi+, Omega-, Anti-Omega+
    	std::initializer_list<int> pdgIds = {310, 3122, -3122, 3312, -3312, 3334, -3334};
	...
	//Inv. pT spectra of Lambda/Anti-Lambda for various y_CM (fig 2.2)
	...
	//Inv. pT spectra of Xi/Anti-Xi for various y_CM (fig 2.3)
	...
	//Inv. pT spectra of Omega/Anti-Omega for various y_CM (fig 2.4)
	...
	//Inv. pT of Lambda/Anti-Lambda for various y_CM in pPB (fig 5.2)
	...
	//Fig 6.3, Y_asym for 1.3 < |yCM| < 1.8
	//Y_asym high for K0s
	string refname7 = mkAxisCode(23, 1, 1);
	const Scatter2D& refdata7 = refData(refname7);
	book(hInvariantPTK0SpPB["HighNeg"], refname7 + "_HighNeg", refdata7);
	book(hInvariantPTK0SpPB["HighPos"], refname7 + "_HighPos", refdata7);
	book(YasymHighK0s["-1.8<yCM<-1.3/1.3<yCM<1.8"], refname7);
	
	//Y_asym high for Lambdas
  ...
  DECLARE_RIVET_PLUGIN(CMS_2020_I1758692);
